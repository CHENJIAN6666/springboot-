...
public class One2Many extends JSONObject {
    ...
    private Set<Integer> roleCodeList;
    private Set<String> roleNameList;
    
    private List<JSONObject> userRoleList;
    private List<JSONObject> mCardRulesOrgList;
    private List<JSONObject> payOrderDetailList;

    private List<JSONObject> allSalesList;
